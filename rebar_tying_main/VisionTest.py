...
#2024/1/5 continue...
def rodrigues_rotation(surface_normal):
...
def VisionProcess():
    ...
    while True:
        ...
        for i in range(masks.size(0)):
            ...
            normal2RotVec = rodrigues_rotation(surface_normal)
...
if __name__ == '__main__':
   ...
   point_indx = VisionProcess()
   normal2RotVec = np.array([point_indx[0][1][3],point_indx[0][1][4],point_indx[0][1][5]])
   normal2RotM,_ = cv2.Rodrigues(normal2RotVec)
   print(normal2RotM)
   pos_org = np.array([-109.8, -4.3, 162.6])
   pos_last = np.dot(normal2RotM,pos_org)
   print(pos_last)
#    print(point_indx)
